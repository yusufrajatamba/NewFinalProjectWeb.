...
WebUI.setText(findTestObject('Object Repository/Page_Register Now  Kotakoki/input_Username_'), username)

WebUI.setText(findTestObject('Object Repository/Page_Register Now  Kotakoki/input_E-mail'), email)

WebUI.setText(findTestObject('Object Repository/Page_Register Now  Kotakoki/input_Phone Number'), phonenumber)

WebUI.setText(findTestObject('Object Repository/Page_Register Now  Kotakoki/input_Password'), password)

WebUI.setText(findTestObject('Object Repository/Page_Register Now  Kotakoki/input_Confirm Password'), password)
