...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Kotakoki  Welcome to my Website/span_Shop'), 0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Cart  Kotakoki/td_Frozen Tempe Furai Original 400 g'), 
    3)

WebUI.click(findTestObject('Object Repository/Page_Cart  Kotakoki/a_Continue shopping'))

WebUI.click(findTestObject('Object Repository/Page_Products  Kotakoki/thumbnail s_432ea2'))

WebUI.setText(findTestObject('Object Repository/Page_Beanie  Kotakoki/input_Beanie quantity'), '3')

WebUI.click(findTestObject('Object Repository/Page_Beanie  Kotakoki/img_Search_wp-post-image'))

WebUI.verifyElementPresent(findTestObject('Page_Beanie  Kotakoki/img_Copyright  2022. Powered by WS Lab_pswp__img'), 0)

WebUI.click(findTestObject('Page_Beanie  Kotakoki/img_Copyright  2022. Powered by WS Lab_pswp__img'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Page_Beanie  Kotakoki/button_Add to cart'))

WebUI.click(findTestObject('Object Repository/Page_Beanie  Kotakoki/a_View cart'))
