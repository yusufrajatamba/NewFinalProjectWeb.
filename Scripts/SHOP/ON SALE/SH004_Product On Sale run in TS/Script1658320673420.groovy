...
WebUI.verifyElementPresent(findTestObject('Page_Products  Kotakoki/li_On Sale4'), 3)

WebUI.click(findTestObject('Page_Products  Kotakoki/li_On Sale4'))
...
WebUI.click(findTestObject('Object Repository/Page_Cap  Kotakoki/a_View cart'))
